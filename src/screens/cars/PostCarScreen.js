...
export default function PostCarScreen({ navigation }) {
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      Alert.alert('Posted!', 'Your car listing is now live.', [
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Post Vehicle Listing</Text>
        <View style={{ width: 32 }} />
      </View>
      ...
      >
        ...
        >
          {loading ? (
            ...
            <>
              <Ionicons name="car-outline" size={22} color={COLORS.textOnGold} />
...
const styles = StyleSheet.create({
  ...
  contactInput: { flex: 1, fontSize: 15, color: COLORS.textPrimary, paddingVertical: 12, marginLeft: 10 },
