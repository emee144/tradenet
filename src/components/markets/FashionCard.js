...
export default function FashionCard({ item, onPress }) {
  const {
    title,
    price,
    category,
      ...
      <View style={styles.details}>
        ...
        {seller && (
          <View style={styles.sellerRow}>
            ...
            <Text style={styles.sellerName} numberOfLines={1}>{seller.full_name}</Text>
...
const styles = StyleSheet.create({
  ...
  conditionText: { color: COLORS.textOnGold, fontSize: 12, fontWeight: '700' },
